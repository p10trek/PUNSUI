    ...
    install(Vue) {
        ...
        Vue.prototype.startSignalR = () => {
            ...
            connection.on('PlayerJoined', (playerId) => {
                console.log("plauer joined gamehub")
        ...
        gameHub.playerGuessed = (gameId, nextPlayerId) => {
            ...
            return startedPromise
                .then(() => connection.invoke('PlayerGuessed', gameId, nextPlayerId))
                .catch(console.error)
        }
        ...
        gameHub.newShowingPlayer = (gameId, playerId) => {
            ...
            return startedPromise
                .then(() => connection.invoke('NewShowingPlayer', gameId, playerId))
                .catch(console.error)
        }
        ...
        gameHub.removeFromGameGroup = (gameId, playerId) => {
            ...
            return startedPromise
                .then(() => connection.invoke('RemoveFromGameGroup', gameId, playerId))
                .catch(console.error)
        }
